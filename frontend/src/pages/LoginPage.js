      ...
      <div className="auth-left">
        <div className="auth-left-inner">
          ...
          <p className="auth-left-sub">
            Join 10,000+ students who manage their finances with BudgetBuddy — completely free.
          </p>
          <div className="auth-features-list">
            {['📊 Real-time spending charts','🔔 Budget overspend alerts','🎯 Savings goal tracker','📋 Full expense history'].map((f, i) => (
        ...
        <div className="auth-form-wrap">
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <button type="submit" className="auth-submit-btn" disabled={loading}>
              {loading ? <span className="btn-spinner" /> : <><span>Sign In</span><FaArrowRight /></>}
            </button>
          </form>
